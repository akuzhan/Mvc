...
namespace Microsoft.AspNet.Mvc
{
    ...
    public sealed class SerializableError : Dictionary<string, object>, IXmlSerializable
    {
        ...
        public SerializableError([NotNull]ModelStateDictionary modelState)
        {
            ...
            {
                throw new InvalidOperationException(Resources.HttpError_ValidModelState);
            }
            ...
            foreach (var keyModelStatePair in modelState)
            {
                ...
                if (errors != null && errors.Count > 0)
                {
                    ...
                    {
                        return string.IsNullOrEmpty(error.ErrorMessage) ? Resources.HttpError_ErrorFiller : error.ErrorMessage;
                    }).ToArray();
